 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Holiday implements ArrayAccess
{
    ...
    {
        $this->container['holidayId'] = isset($data['holidayId']) ? $data['holidayId'] : null;
    ...
    {
        return $this->container['holidayId'];
    }

    /**
     * Sets holidayId
     * @param int $holidayId The ID of this holiday. Read-only
     * @return $this
     */
    public function setHolidayId($holidayId)
    {
        $this->container['holidayId'] = $holidayId;
    ...
    {
        if ((strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Holiday., must be smaller than or equal to 200.');
        }
    ...
    /**
     * Sets endDate
     * @param string $endDate End date of the holiday if more than 1 day
     * @return $this
     */
