...
class Client implements ArrayAccess
{
    ...
    /**
     * Sets clientId
     * @param int $clientId The ID of this client. Read-only
     * @return $this
     */
    ...
    {
        if ((strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Client., must be smaller than or equal to 200.');
        }
