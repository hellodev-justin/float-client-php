 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PeopleTag implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PeopleTag';
    ...
    {
        if ((strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PeopleTag., must be smaller than or equal to 200.');
        }
    ...
    /**
     * Sets type
     * @param int $type Categorization of people tags. Current supported values
     * @return $this
     */
