...
class Department implements ArrayAccess
{
    ...
    /**
     * Sets departmentId
     * @param int $departmentId The ID of this department. Read-only
     * @return $this
     */
    ...
    {
        if ((strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Department., must be smaller than or equal to 200.');
        }
